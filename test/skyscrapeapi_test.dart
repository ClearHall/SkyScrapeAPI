...
void main() async {
  String url = "https://skyward-alvinprod.iscorp.com/scripts/wsisa.dll/WService=wsedualvinisdtx/skyporthttp.w";
  var skyward = SkywardAPICore(url);
  ...
  group('Group tests on network WITH enabled refresh', () {
    ...
    test('test assignment getting second', () async{
      skyward.loginSessionRequiredBodyElements['dwd'] = 'ON_PURPOSE_TRY_TO_GET_ERROR';
      SkywardAPICore testCore = SkywardAPICore(url);
